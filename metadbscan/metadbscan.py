...
class MetaDBSCAN(object):
    ...
    def binFile(self, args):
        self.logger.info('')
        self.logger.info('*******************************************************************************')
        self.logger.info(' [MetaDBSCAN - bin_file] Creating file indicating bin assignments.')
        self.logger.info('*******************************************************************************')
        ...
        fout.write('# Created with metadbscan binFile command\n')
    ...
    def binStats(self, args):
        self.logger.info('')
        self.logger.info('*******************************************************************************')
        self.logger.info(' [MetaDBSCAN - bin_stats] Creating file with statistics for binned scaffolds.')
        self.logger.info('*******************************************************************************')
